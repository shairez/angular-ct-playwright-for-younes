...
@Component({
  ...
  template: `
    <div
      class="bg-white rounded-lg shadow-lg w-full max-w-md mx-auto p-6 max-h-[90vh] overflow-y-auto"
    >
      ...
      <form [formGroup]="settingsForm" (ngSubmit)="saveSettings()">
        ...
        <div class="mb-4">
          ...
          <p class="mt-1 text-xs text-gray-500">
            Select the environment to pull benchmark data from
          </p>
        </div>
        ...
        <div class="mb-4">
          ...
          <p class="mt-1 text-xs text-gray-500 ml-6">
            When enabled, data will refresh automatically at the specified
            interval
          </p>
        </div>
